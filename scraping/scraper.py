...
def extract_sections(soup):
    ...
    for element in root.find_all(["h1", "h2", "h3", "h4", "h5", "h6", "p", "pre"]):
        ...
        if tag in ["h1", "h2", "h3", "h4", "h5", "h6"]:
            # CRITICAL: Squash internal rogue newlines inside headers (e.g. <h2>Title\nSubtitle</h2>)
    ...
    # Let the joiner handle the spacing; don't manually inject '\n' into the list items
